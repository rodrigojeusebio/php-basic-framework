<h1 class="text-2xl font-semibold text-slate-800 text-center mb-6">Create a Task</h1>
<form action="/tasks" method="post" class="max-w-md mx-auto space-y-6">
    <!-- Task Input -->
    <div class="space-y-2">
        <label for="description" class="block text-sm font-medium text-gray-700">Task Description</label>
        <input type="text" id="description" name="description" placeholder="I will do..." value="<?  echo htmlspecialchars(old('description') ?? '');  ?>"
...
<?  endif;  ?>
    ...
    <div class="space-y-2">
        ...
        <div class="flex items-center space-x-2">
            <input type="checkbox" id="complete" name="complete" <?= old('complete', 0) ? 'checked' : '' ?> value="1"
